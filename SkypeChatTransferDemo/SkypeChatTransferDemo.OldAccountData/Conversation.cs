...
namespace SkypeChatTransferDemo.OldAccountData
{
    ...
    public partial class Conversation
    {
        ...
        public Nullable<long> optimal_remote_videos_in_conference { get; set; }
        public Nullable<long> live_start_timestamp { get; set; }
        public Nullable<long> live_is_muted { get; set; }
        public Nullable<long> max_videoconfcall_participants { get; set; }
        ...
        public Nullable<long> consumption_horizon__ms { get; set; }
        ...
        public Nullable<long> extprop_conversation_first_unread_emote { get; set; }
        public Nullable<long> opt_moderated { get; set; }
        public Nullable<long> migration_instructions_posted { get; set; }
        public Nullable<long> consumption_horizon_rid { get; set; }
        public Nullable<long> consumption_horizon_crc { get; set; }
        public Nullable<long> consumption_horizon_bookmark { get; set; }
        public Nullable<long> live_is_hostless { get; set; }
        public string reaction_thread { get; set; }
        public string client_id { get; set; }
        public Nullable<long> last_synced_message_id { get; set; }
        public Nullable<long> last_synced_message_version { get; set; }
        public Nullable<long> last_synced_days { get; set; }
